...
//         "https://mdl-coaching-hpjt.onrender.com/notes/sendnotes"
//       );
...
const StudentLearningMaterial = () => {
  ...
  const handleDownload = async (fileUrl) => {
    try {
      const response = await axios.get(`https://mdl-coaching-hpjt.onrender.com/images/${fileUrl}`, { responseType: "blob" });
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get(`https://mdl-coaching-hpjt.onrender.com/notes/sendnotes/${localStorage.getItem("studentclass")}`);
      console.log(res.data);
