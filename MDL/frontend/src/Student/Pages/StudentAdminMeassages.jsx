...
//             "https://mdl-coaching-hpjt.onrender.com/notice/getnoticestudent"
//           );
...
const StudentAdminMessages = () => {
  ...
  const fetchNotice = async () => {
    try {
      const response = await axios.get("https://mdl-coaching-hpjt.onrender.com/notice/getnoticestudent");
