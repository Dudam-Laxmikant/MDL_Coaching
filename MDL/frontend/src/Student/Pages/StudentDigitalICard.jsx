...
import { FaEye, FaEdit, FaUserCircle, FaUser, FaSignOutAlt, FaArrowLeft } from "react-icons/fa";
            ...
            <div className="flex-grow flex items-center justify-center p-24">
                <div className="bg-white text-gray-900 shadow-xl rounded-2xl w-96 p-10 border-4 border-indigo-600 relative">
                    <div className="flex flex-col items-center">
                        ...
                        >
                            <img className="w-full h-full object-cover" src={image || "https://via.placeholder.com/100"} alt="Student" />
                            {showOptions && (
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 space-x-4">
                                    <FaEye className="text-white text-2xl cursor-pointer" title="View" onClick={() => setIsModalOpen(true)} />
                        ...
                        <div className="mt-4 text-center">
                            <h3 className="text-2xl font-bold text-indigo-800">John Doe</h3>
                            <p className="text-indigo-600 text-md font-semibold">🆔 Student ID: 123456789</p>
                        </div>
                    </div>

                    {/* Student Info */}
                    <div className="mt-4 border-t border-gray-300 pt-4 text-left space-y-3">
                        <p className="text-gray-700 text-lg"><strong>📍 Address:</strong> 123 Street, City, State</p>
                        <p className="text-gray-700 text-lg"><strong>📞 Mobile:</strong> +123 456 7890</p>
                        <p className="text-gray-700 text-lg"><strong>🏫 Coaching Name:</strong> XYZ Institute</p>
                    </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-xl shadow-xl w-80 text-center">
                        <img className="w-full h-auto rounded-lg" src={image || "https://via.placeholder.com/100"} alt="Student" />
                        <button className="mt-4 px-6 py-2 bg-indigo-600 text-white rounded-lg shadow-md" onClick={() => setIsModalOpen(false)}>OK</button>
                    </div>
                </div>
            )}
