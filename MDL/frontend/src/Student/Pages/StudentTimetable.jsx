      ...
      <div className="flex-grow flex items-center justify-center p-4 mt-20">
        ...
        <motion.div
          ...
          <div className="overflow-x-auto flex justify-center">
            ...
            <motion.img
              src={table ? `https://mdl-coaching-hpjt.onrender.com/images/${table}` : "https://www.shutterstock.com/image-vector/timetable-error-color-line-icon-600w-1923052244.jpg"}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.8 }}
