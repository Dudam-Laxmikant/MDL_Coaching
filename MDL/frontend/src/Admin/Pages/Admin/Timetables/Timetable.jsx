...
//                 {/* Aside Section */}
//                 <aside className="w-full bg-gray-700 p-6 mt-10 rounded-lg text-center">
//                     <h2 className="text-white text-xl">Uploaded Timetables</h2>
//                     <div className="mt-4">
...
//                                         <tr key={file.id} className="bg-gray-600">
