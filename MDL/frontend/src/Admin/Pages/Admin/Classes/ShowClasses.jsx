...
//         try {
//           const url = `https://mdl-coaching-hpjt.onrender.com/class/deleteclass/${classid}`;
...
//     try {
//       const res = await axios.get("https://mdl-coaching-hpjt.onrender.com/class/classBystudent");
