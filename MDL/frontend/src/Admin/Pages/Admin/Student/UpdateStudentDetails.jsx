...
// import React, { useState } from 'react';
// import { Link } from 'react-router-dom';
// import { FaUser, FaCity, FaFlag, FaMoneyBillWave, FaIdCard, FaCalendarAlt, FaHome, FaSchool } from 'react-icons/fa';
// import Header from '../Home/Header';
// import Footer from '../Home/Footer';
// import Swal from 'sweetalert2';
...
//                         </div>
//                         {[
//                             { label: "First Name", name: "firstName", icon: <FaUser className="text-blue-400" />, type: "text", placeholder: "Enter First Name" },
//                             { label: "Last Name", name: "lastName", icon: <FaUser className="text-red-400" />, type: "text", placeholder: "Enter Last Name" },
//                             { label: "Father's Name", name: "fathersName", icon: <FaUser className="text-green-400" />, type: "text", placeholder: "Enter Father's Name" },
//                             { label: "Date of Birth", name: "dob", icon: <FaCalendarAlt className="text-yellow-400" />, type: "date" },
//                             { label: "Aadhar Number", name: "aadharNumber", icon: <FaIdCard className="text-purple-400" />, type: "number", placeholder: "Enter Aadhar Number" },
//                             { label: "City", name: "city", icon: <FaCity className="text-orange-400" />, type: "text", placeholder: "Enter City" },
//                             { label: "Country", name: "country", icon: <FaFlag className="text-pink-400" />, type: "text", placeholder: "Enter Country" },
//                             { label: "Address", name: "address", icon: <FaHome className="text-blue-500" />, type: "text", placeholder: "Enter Address" },
//                             { label: "Fee Amount", name: "feeAmount", icon: <FaMoneyBillWave className="text-teal-400" />, type: "text", placeholder: "Enter Fee Amount" }
//                         ].map((field, index) => (
//                             <div key={index} className="flex flex-col">
//                                 <label className="text-gray-300 font-medium mb-1">{field.label}</label>
...
//     <div className="relative flex items-center">
//         <span className="absolute left-3"><FaSchool className="text-yellow-400" /></span>
//         <select name="studentClass" value={formData.studentClass} onChange={handleChange} className="w-full pl-12 p-3 border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition">
            ...
            <div className="flex flex-col">
              ...
              <div className="relative flex items-center">
                ...
                <textarea
                  ...
                  className="w-full pl-12 p-3 border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition h-24"
                ></textarea>
              </div>
            </div>
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full p-2 border border-gray-600 rounded-lg bg-gray-700 file:bg-blue-500 file:text-white file:px-3 file:py-1 file:rounded-lg file:border-none file:cursor-pointer hover:file:bg-blue-600 transition"
              />
            </div>
            <div className="flex flex-col">
              <label className="text-gray-300 font-medium mb-1">
