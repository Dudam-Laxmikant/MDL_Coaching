...
function UpdateStudentDetails() {
  ...
  const updateStudentDetails = async (e) => {
    e.preventDefault();
    try {
      const url = `https://mdl-coaching-hpjt.onrender.com/student/Updatestudentdetails/${studentId}`;
  ...
  const fetchdata = async () => {
    try {
      const response = await axios.get(
        `https://mdl-coaching-hpjt.onrender.com/student/showprofile/${studentId}`
      );
...
//         setPreview(`https://mdl-coaching-hpjt.onrender.com/images/${response.data.data.passphoto}`);
//       }
//     } catch (error) {
//       console.log("Not Found Error", error);
//     }
