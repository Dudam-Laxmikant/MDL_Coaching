...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
        {loading && (
          <div className="absolute inset-0 z-50 bg-opacity-50 flex items-center justify-center">
            <div className="relative w-24 h-24">
              {/* Outer Ring */}
              <div className="w-full h-full border-4 border-yellow-400 border-dashed rounded-full animate-spin"></div>

              {/* Dots inside */}
              <div className="absolute inset-0 flex items-center justify-center space-x-2">
                <span className="w-3 h-3 bg-yellow-400 rounded-full animate-bounce"></span>
                <span className="w-3 h-3 bg-yellow-400 rounded-full animate-bounce [animation-delay:0.2s]"></span>
      ...
      <div className="flex-1 bg-[#454649] p-5 sm:p-7 md:p-20 mt-4 min-h-screen relative">
