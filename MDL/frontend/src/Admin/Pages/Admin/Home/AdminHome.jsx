...
function AdminHome() {
  ...
  function delet(noticeId) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          const url = `https://mdl-coaching-hpjt.onrender.com/notice/delete/${noticeId}`;
  ...
  useEffect(() => {
    const gettotals = async () => {
      const response = await axios.get("https://mdl-coaching-hpjt.onrender.com/TotalAdminDashboards");
  ...
  const getnotice = async () => {
    try {
      ...
      const url = "https://mdl-coaching-hpjt.onrender.com/notice/notice";
      const response = await axios.get(url);
