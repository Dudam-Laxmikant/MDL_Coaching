...
//         "https://mdl-coaching-hpjt.onrender.com/teacher/displayallteachers"
//       );
...
//         "https://mdl-coaching-hpjt.onrender.com/teacherclass/teachercls",
//         {
//           TeacherId: teacherid,
//           className: classid,
//         },
...
export const AddClassTeacher = () => {
  ...
  const fetchAllTeachers = async () => {
    try {
      const response = await axios.get("https://mdl-coaching-hpjt.onrender.com/teacher/displayallteachers");
