      ...
      <div className="flex flex-1 bg-[#454649] p-5 sm:p-7 md:p-14">
        <div className="w-full max-w-6xl mx-auto bg-[#454649] p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="relative">
              <FiUser className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" size={20} />
              <input type="text" placeholder="Enter Name" className="w-full pl-10 pr-4 py-3 border border-gray-600 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400 shadow-md" />
            </div>
            <div className="relative">
              <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" size={20} />
              <input type="text" placeholder="Enter Teacher ID" className="w-full pl-10 pr-4 py-3 border border-gray-600 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400 shadow-md" />
            </div>
          </div>
                    ...
                    <td className="p-4 flex flex-wrap justify-center gap-2">
                      ...
                      <Link to="/showclassTeacher/showallteacherlist/salarydetails">
                        <button className="p-2 bg-yellow-500 text-white rounded shadow hover:bg-yellow-600 transition flex items-center">
                          <FiDollarSign size={18} className="md:mr-1" /> <span className="hidden md:inline">Salary</span>
                        </button>
                      </Link>
                      <button onClick={() => handleDelete(teacher.id)} className="p-2 bg-red-500 text-white rounded shadow hover:bg-red-600 transition flex items-center">
