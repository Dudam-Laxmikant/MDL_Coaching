...
//         "https://mdl-coaching-hpjt.onrender.com/teacher/getallteacher"
//       );
...
//         await axios.get(`https://mdl-coaching-hpjt.onrender.com/teacher/deleteteacher/${tid}`);
//         Swal.fire(
//           "Deleted!",
...
function ShowAllTeachersList() {
  ...
  const fetchAllTeachers = async () => {
    ...
    try {
      const response = await axios.get("https://mdl-coaching-hpjt.onrender.com/teacher/getallteacher");
      setTeachers(response.data.data);
      setFilteredTeachers(response.data.data);
    } catch (error) {
      console.error("Error fetching teachers:", error);
