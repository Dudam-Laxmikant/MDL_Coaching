...
//         `https://mdl-coaching-hpjt.onrender.com/teacher/displaydata/${teacherid}`
//       );
...
//       try {
//         const url = `https://mdl-coaching-hpjt.onrender.com/teacher/UpdateTeacherdetails/${teacherid}`;
...
function UpdateTeacherDetails() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const teacherRes = await axios.get(`https://mdl-coaching-hpjt.onrender.com/teacher/displaydata/${teacherid}`);
        setFormData(teacherRes.data.data);
        const subjectRes = await axios.get("https://mdl-coaching-hpjt.onrender.com/subject/getsubjects");
  ...
  const updateTeachertDetails = async (e) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.post(
          `https://mdl-coaching-hpjt.onrender.com/teacher/UpdateTeacherdetails/${teacherid}`,
          formData,
          {
            headers: { "Content-Type": "application/json" },
          }
