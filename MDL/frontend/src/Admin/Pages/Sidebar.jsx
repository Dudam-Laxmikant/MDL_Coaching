...
import { FiGrid , FiLayers , FiUsers, FiInbox   , FiUser, FiLogOut, FiX, FiBookOpen, FiUserPlus, FiBell } from 'react-icons/fi';
...
const Sidebar = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <div className={`fixed left-0 top-0 h-screen w-72 bg-black text-white shadow-lg transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"} z-50`}>
            {/* Close Button */}
