...
const TeacherDashboard = () => {
  ...
  const newsList = [
    { title: "New Feature Released", date: "2025-03-05", audience: "Public", description: "A new feature has been added to the platform!", bg: "bg-green-200" },
    { title: "Scheduled Maintenance", date: "2025-03-04", audience: "Teachers", description: "System maintenance is scheduled for this date.", bg: "bg-gray-200" },
    { title: "Upcoming Webinar", date: "2025-03-02", audience: "Students", description: "Join us for an informative webinar.", bg: "bg-gray-200" },
    { title: "Upcoming Webinar on 03-03-2025", date: "2025-03-01", audience: "Students", description: "Learn more about our upcoming webinar on this date.", bg: "bg-gray-200" },
  ];
      ...
      <div className="flex flex-1 h-screen relative">
        ...
        <div className={`flex-1 p-6 bg-gray-50 transition-all duration-300`}>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center">
            {[{ label: "Total tests taken", value: testCount, icon: <FaFileAlt size={40} />, color: "bg-blue-500" },
              { label: "Total salary earned", value: `₹${salary.toLocaleString()}`, icon: <FaMoneyBillWave size={40} />, color: "bg-green-500" },
              { label: "Total classes taken", value: classCount, icon: <FaChalkboardTeacher size={40} />, color: "bg-purple-500" }].map((stat, index) => (
              <div
                key={index}
                className={`p-6 ${stat.color} text-white rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl flex flex-col items-center`}
              >
      ...
      {selectedNews && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="text-sm text-gray-600 mb-2">{selectedNews.date} - {selectedNews.audience}</p>
