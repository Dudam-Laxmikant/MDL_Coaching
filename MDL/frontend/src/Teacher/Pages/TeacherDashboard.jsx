  ...
  const newsList = [
    {
      ...
      date: "2025-03-05",
      audience: "Public",
      description: "A new feature has been added to the platform!",
      bg: "bg-green-200",
    },
    {
      ...
      date: "2025-03-04",
      audience: "Teachers",
      description: "System maintenance is scheduled for this date.",
      bg: "bg-gray-200",
    },
    {
      ...
      date: "2025-03-02",
      audience: "Students",
      description: "Join us for an informative webinar.",
      bg: "bg-gray-200",
    },
    {
      title: "Upcoming Webinar on 03-03-2025",
      date: "2025-03-01",
      audience: "Students",
      description: "Learn more about our upcoming webinar on this date.",
      bg: "bg-gray-200",
    },
  ];
