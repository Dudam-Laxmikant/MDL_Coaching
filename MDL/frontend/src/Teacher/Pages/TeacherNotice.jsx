...
const TeacherNotice = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      const url = "https://mdl-coaching-hpjt.onrender.com/t_notice/teachernotice";
  ...
  const getallnotice = async () => {
    try {
      const res = await axios.get(
        "https://mdl-coaching-hpjt.onrender.com/t_notice/teachernotice/getallnotice"
      );
      console.log(res.data);
  ...
  function delet(noticeId) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          const url = `https://mdl-coaching-hpjt.onrender.com/t_notice/teachernotice/delete/${noticeId}`;
